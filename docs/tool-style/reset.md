...
html, body ,button, input, select, textarea, pre{
  font-family: PingFangSC-Regular, 'PingFang SC', arial, tahoma, 'Microsoft Yahei', '\5b8b\4f53', sans-serif;
}
...
/*Default backround color and color.*/
body {
  color: #333;
...
/*Reset all italic element to normal.*/
